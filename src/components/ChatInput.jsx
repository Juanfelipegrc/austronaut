        ...
        <form className='fixed bottom-10 w-[90%] lg:w-[60%]'>
            <div className='relative'>
                <input 
                    ...
                    className='h-24 w-full shadow-[0_0.1rem_0.6rem_rgba(0,0,0,0.25)] dark:shadow-[0_0.1rem_0.8rem_rgba(255,255,255,0.25)] bg-[#F4F6F8] dark:bg-[#F4F6F8] rounded-3xl px-4 placeholder-gray-600 focus-visible:outline-0 pb-[1.90rem]' 
                />
