...
export const LoginRegisterButton = () => {
    ...
    const {status, darkMode, displayName} = useAuth();
  ...
  return (
    <>
        ...
        <motion.div 
            ...
            animate={
                expanded
                ? {width: '100vw', height: '100vh', top: 0, left:0, transition: {duration: 0.5, ease: 'easeInOut'}}
                    ...
                    !expanded?
                        ...
                        <>
                            ...
                            fill={darkMode? '#EDEDED' : '#333333'}>
                                <path d={status === 'authenticated'? "M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z" : 'M480-120v-80h280v-560H480v-80h280q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H480Zm-80-160-55-58 102-102H120v-80h327L345-622l55-58 200 200-200 200Z'}/>
                            </svg>
